    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (input[0] != 'q')
            {
                ...
                float dist = (float)MathF.Sqrt(deltaX*deltaX + deltaY*deltaY);
                float radians = (float)MathF.Atan2(deltaY, deltaX);
                float angle = (float)radians * (180 / MathF.PI);
                Console.Write(dist+" "+angle);
                Console.WriteLine();
